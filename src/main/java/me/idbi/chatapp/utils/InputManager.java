...
public class InputManager {
    ...
    public void getInput(String text, Consumer<String> consumer, Runnable exit) {
        try {
            Main.getClientData().getTerminalManager().getKeyboardListener().setInputMode(true, StringPatterns.NONE);
    ...
    public void getInput(String text, StringPatterns pattern, Consumer<String> consumer, Runnable exit) {
        try {
            Main.getClientData().getTerminalManager().getKeyboardListener().setInputMode(true, pattern);
            Main.getClientData().getTerminalManager().getKeyboardListener().setInputPrompt("");
